                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="{{ asset('upload/blog/'.$img[0]) }}" width="150" /> </td>

                                            <td>{{$row->description}}</td>

                                            <td>
                                                <a href="{{ url('admin/blog/edit/'.$row->id) }}">Edit</a>
                                                <a href="{{ url('admin/blog/delete/'.$row->id) }}">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
